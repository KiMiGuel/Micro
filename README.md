...
- **[MicroStacks](MicroStacks/)** — a token registry and usage-accounting
  ...
  MicroVault.
- **MicroWallet** — reserved for a future, more involved project. Empty
  for now.

Most active development happens in MicroVault and MicroStacks. See each
one's own README for what it does and how to use it.
